...
function ViewGigDetails(){
    ...
    return(
        <div  style={{ backgroundColor: "#fff", width: "66.8%",minHeight: "min-content",margin:"10px 10px 10px 0px", padding:"0px 10px 0px 10px", position:"absolute", left:"0%", top:"70px"}}>
        <form>
          <div style={{backgroundColor:"#f8f9fa",marginBottom:"20px", width:"100%",borderRadius:"4px",height:"100vh", boxShadow:"3px 3px 4px rgba(0, 0, 0, 0.1)", marginBottom:"10px", padding:"15px"}}>
            <div style={{marginTop:"8px",paddingTop:"0px", display:"flex"}}>
                <div >
                    <img style={{width:"400px", height:"250px",paddingRight:"0px",borderRadius:"4px"}} src={`http://localhost:10200/${gig.file}`} alt="gigImage" />
                </div>
                <div>
                    <div style={{marginTop:"8px",paddingTop:"0px",position:"absolute", left:"55%"}}>
                        <h4 style={{textAlign:"center"}}>{gig.title}</h4>
                        <hr/>
                    </div>
                    <div style={{marginTop:"45px",paddingTop:"35px",position:"relative", left:"20px"}}>
                        <h5>Category</h5>
                        <div style={{display:"flex"}}>
                            <p>{gig.category} <b>for , </b></p>  <p>{gig.subcategory}</p><hr/>
                        </div>
                    </div>
                    <div style={{marginTop:"8px",paddingTop:"15px",position:"relative", left:"20px"}}>
                        <h5>Price</h5>
                        <h3 style={{textAlign:"left", color:"#67ba6a"}}>{gig.price}</h3>
                    </div>
            ...
            <div class="mb-3 container">
                <button style={{backgroundColor:"#67ba6a",marginBottom:"20px", border:"#67ba6a",fontWeight:"bold", outline:"none",width:"20%",position:"absolute",left:"24px", textAlign:"center", padding:"10px 0px 10px 0px", borderRadius:"4px",color:"white"}} onClick={handleAddOrderClick}>Add a oder</button>
            </div>
          </div>
          </form>
