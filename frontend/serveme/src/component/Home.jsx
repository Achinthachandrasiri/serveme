        ...
        <div className="mb-3 container">
            <form onSubmit={(e) => fetchData(e)}  style={{ marginTop: "20px" }}>
                <div className="homeSubDiv">
                    <div class="mb-3 container inputFeild">
                    ...
                    <div className="mb-3 container inputFeild">
            ...
            {/*gig results........................................................................................................................*/}
            <div className="gig-list mb-3 container searchResult">
                {gigs.map((gig, index) => (
                    <div data-aos="zoom-in" key={index} className="gig-card box">
