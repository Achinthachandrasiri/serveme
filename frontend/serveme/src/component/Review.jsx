...
import ReviewCss from '../css/Reviews.css'
...
function Review({ profileId }) {
    ...
    return (
        <div className="mainReviewDiv" style={{ display: "block" }}>
            <div className="ReviewsubDiv">
                <div className="ReveiwDiv">
                ...
                <div className="ReveiwDiv">
                    <p className="ReviewH">"I recently hired John's Electrical Services to fix some wiring issues in my home, and I couldn't be happier with the results. John was prompt, professional, and got the job done quickly. My lights are working perfectly now! Highly recommend."</p>
                </div>
                <div className="ReveiwDiv">
                    <p className="ReviewH">"Incredibly knowledgeable and courteous. The electrician diagnosed the problem quickly and rewired my entire house efficiently and safely. I feel much safer now knowing the work was done by professionals. Thank you, Sparky Solutions!"</p>
                </div>
                <div className="ReveiwDiv">
                    <p className="ReviewH">"in the hour, diagnosed the problem quickly, and had it fixed in no time. Their prices were reasonable, and the service was top-notch. I'll definitely be using them again."</p>
                </div>
                <div className="ReveiwDiv">
                    <p className="ReviewH">" in the hour, diagnosed the problem quickly, and had it fixed in no time.rived at my door within the hour, diagnosed the problem quickly, and had it fixed in no time. Their prices were reasonable, and the service was top-notch. I'll definitely be using them again."</p>
                </div>
                <div>
